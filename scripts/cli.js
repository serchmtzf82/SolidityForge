...
const contractABI = require("../artifacts/contracts/Solidityforge.sol/Solidityforge.json").abi;

program
    .name("solidityforge-cli")
    .description("CLI tool for Solidityforge smart contract")
    .version("1.0.0");
