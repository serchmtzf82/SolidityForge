 ...
 * This file demonstrates how to integrate Solidityforge with a web frontend
 */

// For React/Vue/Angular applications
export class SolidityforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SolidityforgeClient(provider, contractAddress);
